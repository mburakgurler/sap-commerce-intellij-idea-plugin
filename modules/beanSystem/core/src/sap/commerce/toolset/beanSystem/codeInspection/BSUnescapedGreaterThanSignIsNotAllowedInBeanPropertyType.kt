...
class BSUnescapedGreaterThanSignIsNotAllowedInBeanPropertyType : BSInspection() {
    ...
    private fun inspect(
        ...
        holder.createProblem(
            dom.type,
            severity,
            i18n("hybris.inspections.bs.BSUnescapedGreaterThanSignIsNotAllowedInBeanPropertyType.message", propertyName),
