...
class LeExtensionLineMarkerProvider : LeSLineMarkerProvider() {
    ...
    override fun getTooltipText() = i18n("hybris.editor.gutter.le.extension.tooltip.text")
    override fun getPopupTitle() = i18n("hybris.editor.gutter.le.extension.popup.title")
