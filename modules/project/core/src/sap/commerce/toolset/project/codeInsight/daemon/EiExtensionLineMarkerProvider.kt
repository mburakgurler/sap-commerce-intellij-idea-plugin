...
class EiExtensionLineMarkerProvider : EiSLineMarkerProvider() {
    ...
    override fun getTooltipText() = i18n("hybris.editor.gutter.ei.extension.tooltip.text")
    override fun getPopupTitle() = i18n("hybris.editor.gutter.ei.extension.popup.title")
