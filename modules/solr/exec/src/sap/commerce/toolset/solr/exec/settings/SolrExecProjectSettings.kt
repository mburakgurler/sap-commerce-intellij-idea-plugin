...
import sap.commerce.toolset.solr.exec.settings.state.SolrExecProjectSettingsState
...
internal class SolrExecProjectSettings : SerializablePersistentStateComponent<SolrExecProjectSettingsState>(SolrExecProjectSettingsState()), ModificationTracker {
    ...
    companion object {
        @JvmStatic
        fun getInstance(project: Project): SolrExecProjectSettings = project.service()
    }
}