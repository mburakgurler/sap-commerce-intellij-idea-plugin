...
package sap.commerce.toolset.solr.exec.settings

import com.intellij.openapi.components.*
import com.intellij.openapi.project.Project
import com.intellij.openapi.util.ModificationTracker
import sap.commerce.toolset.HybrisConstants
import sap.commerce.toolset.solr.exec.settings.state.SolrExecDeveloperSettingsState
...
internal class SolrExecDeveloperSettings : SerializablePersistentStateComponent<SolrExecDeveloperSettingsState>(SolrExecDeveloperSettingsState()), ModificationTracker {
    ...
    companion object {
        @JvmStatic
        fun getInstance(project: Project): SolrExecDeveloperSettings = project.service()
    }
}