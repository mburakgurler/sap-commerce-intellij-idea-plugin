...
class FlexibleSearchInEditorParametersView(private val project: Project, private val coroutineScope: CoroutineScope) {
    ...
    fun renderParameters(fileEditor: FlexibleSearchSplitEditorEx) {
    ...
    private fun renderParametersPanel(
        ...
        fileEditor: FlexibleSearchSplitEditorEx,
    ): DialogPanel {
    ...
    private fun applyValue(fileEditor: FlexibleSearchSplitEditorEx, parameter: FlexibleSearchVirtualParameter, newRawValue: Any?) {
