...
class PolyglotQueryInEditorParametersView(private val project: Project, private val coroutineScope: CoroutineScope) {
    ...
    fun renderParameters(fileEditor: PolyglotQuerySplitEditorEx) {
    ...
    private fun applyValue(fileEditor: PolyglotQuerySplitEditorEx, parameter: PolyglotQueryVirtualParameter, newRawValue: Any?) {
