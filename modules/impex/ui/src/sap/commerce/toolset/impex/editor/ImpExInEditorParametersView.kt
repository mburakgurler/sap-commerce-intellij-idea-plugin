...
class ImpExInEditorParametersView(private val project: Project, private val coroutineScope: CoroutineScope) {
    ...
    fun renderParameters(fileEditor: ImpExSplitEditorEx) {
    ...
    private fun applyValue(fileEditor: ImpExSplitEditorEx, parameter: ImpExVirtualParameter, newRawValue: String) {
