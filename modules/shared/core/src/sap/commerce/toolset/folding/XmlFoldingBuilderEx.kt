...
package sap.commerce.toolset.folding
...
abstract class XmlFoldingBuilderEx<S : FoldingSettings, T : DomElement>(private val clazz: Class<T>) : FoldingBuilderEx() {
    ...
    abstract val filter: PsiElementFilter
    abstract fun initSettings(project: Project): S
    ...
    fun getCachedFoldingSettings(psi: PsiElement) = psi.parentOfType<XmlFile>(false)
    ...
    companion object {
        const val FALLBACK_PLACEHOLDER = "..."
